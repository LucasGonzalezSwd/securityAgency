  ...
  return (
    <div className="flex w-screen h-[8rem] bg-slate-900">
      ...
      <div className="flex w-full justify-end flex-col items-end">
       <div className="flex w-full justify-end mr-[2.2rem] text-xl p-[1rem] text-white ">Contacto</div>
           <div className="flex w-full mr-[2rem] gap-[1.5rem] p-[1rem] items-end justify-end">
