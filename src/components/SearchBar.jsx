...
const SearchBar = () => {
  ...
  return (
    <div className='flex w-full justify-end mt-[1.8rem] max-[850px]:flex-col max-[850px]:items-end'>
      ...
      <input
      className='border-slate-700 max-[850px]:mb-[1rem]  border-[0.09rem] pl-[0.2rem] w-[13rem]'
        type="text"
      ...
      <div className=' max-[850px]:flex max-[850px]:w-full max-[850px]:justify-end'>
      <button className='ml-4 p-[0.3rem] max-[850px]:h-[2.3rem] max-[850px]:mb-[1rem] w-[5rem] text-white bg-slate-700 rounded-md' onClick={handleSearch}>Buscar</button>
     
     
      <button className='ml-4 p-[0.3rem] max-[850px]:h-[2.3rem] max-[850px]:w-[2.8rem] w-[2.5rem] text-white bg-slate-700 rounded-md' onClick={handleReload}><FontAwesomeIcon icon={faRotate} style={{color: "#ffffff",}} /></button>
      </div>
    </div>
  );
};
